...
<div x-data="{
    ...
    selesaikan(idWo) {
        ...
        window.voltraSave('/aksi/maintenance/' + idWo + '/complete',
            {}, 'Servis selesai · stok dipotong · jurnal beban dibuat.').catch(() => this.saving = false);
    },
    simpanServis() {
            ...
            <x-drawer show="open === {{ $r['id_pemeliharaan'] }}" close="open = null; editing = null" :width="640"
                ...
                <div x-show="editing === {{ $r['id_pemeliharaan'] }}" x-cloak class="mb-5">
                    <div class="card p-4 bg-amber-50/40 border-amber-200">
                        <div class="text-[11.5px] text-amber-900 mb-3">Edit data work order yang masih berjalan. Stok &amp; jurnal baru diproses saat tombol "Selesaikan" ditekan.</div>
